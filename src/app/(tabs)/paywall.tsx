...
import { IconCheck, IconClose, IconSpark, ProtoScreen, PText, Tap } from '@/components/proto';
    ...
    <ProtoScreen>
      <Box direction="row" paddingLeft={16} paddingTop={8}>
        <Tap onPress={() => router.back()} scale={0.94}>
          <Box align="center" bg={t.chip} height={38} justify="center" rounded={12} width={38}>
      ...
      <Box paddingTop={14} paddingX={28}>
        <Box align="center" bg={t.accentSoft} height={52} justify="center" rounded={16} width={52}>
          <IconSpark color={t.accent} size={24} />
        </Box>
        <PText lh={34} ls={-0.3} serif size={27} style={{ marginTop: 16 }} weight="600">
        ...
        <Tap onPress={() => set({ pwPlan: 'annual' })}>
          ...
          >
            ...
            <Box
              ...
              width={22}
            >
              {annual ? <IconCheck color={t.onAccent} size={12} strokeWidth={2.6} /> : null}
            </Box>
          </Box>
        </Tap>
        ...
        <Tap onPress={() => set({ pwPlan: 'monthly' })}>
          ...
          >
            ...
            <Box
              ...
              width={22}
            >
              {annual ? null : <IconCheck color={t.onAccent} size={12} strokeWidth={2.6} />}
            </Box>
          </Box>
        </Tap>
      </Box>
      ...
      <Box paddingX={20} paddingY={14}>
        <Tap
          ...
          scale={0.98}
        >
          <Box align="center" bg={t.accent} height={54} justify="center" rounded={16}>
      ...
      >
        <PText color={t.sub} onPress={() => showToast('Cancel anytime from your account')} size={11.5}>
          Cancel anytime
        </PText>
        <PText color={t.sub} size={11.5}>
          ·
        </PText>
        <PText color={t.sub} onPress={() => showToast('No previous purchase found')} size={11.5}>
          Restore purchase
        </PText>
        <PText color={t.sub} size={11.5}>
          ·
        </PText>
        <PText color={t.sub} onPress={() => showToast('lexipdf.app/terms')} size={11.5}>
          Terms
        </PText>
      </Box>
    </ProtoScreen>
