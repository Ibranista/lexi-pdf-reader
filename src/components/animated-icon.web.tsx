...
// On web there is no native splash screen to hand off from; the page just renders.
export function AnimatedSplashOverlay() {
  return null;
}

// The LexiPDF logo animation as plain CSS keyframes (see animated-icon.module.css).
export function AnimatedIcon() {
  return (
    <div className={classes.tile}>
      <svg width="80" height="80" viewBox="0 0 44 44" style={{ overflow: 'visible' }}>
        <g className={classes.contents}>
          {/* dot first so the stem occludes it while it squeezes out */}
