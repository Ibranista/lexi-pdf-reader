...
export const RECENT_DOCS: RecentDoc[] = [
  {
    name: "Q3 Market Report.pdf",
    meta: "38 pages · yesterday",
    badge: "62%",
    hot: true,
  },
  {
    name: "Attention Is All You Need",
    meta: "15 pages · 2 days ago",
    badge: "New",
    hot: false,
  },
  {
    name: "Rental Agreement — Final",
    meta: "12 pages · 3 days ago",
    badge: "100%",
    hot: true,
  },
  {
    name: "Amharic Phrasebook",
    meta: "96 pages · last week",
    badge: "8%",
    hot: false,
  },
];
...
export const PARAGRAPHS: ParaSegment[][] = [
  ...
  [
    ...
    {
      kind: "text",
      text: " city carried a cost that its architects rarely acknowledged. ",
    },
    {
      kind: "select",
...
export const CORPUS = [
  {
    p: 44,
    txt: "Chapter 3 · The Electric Century began not in a laboratory but on Wall Street",
  },
  {
    p: 47,
    txt: "the electric lamps of Pearl Street fed four hundred storefronts and offices",
  },
  {
    p: 51,
    txt: "an electric future its investors could scarcely imagine was already arriving",
  },
  {
    p: 52,
    txt: "gaslight lingered in the poorer wards for another thirty years",
  },
  {
    p: 63,
    txt: "the electric grid grew city by city, wire by wire, franchise by franchise",
  },
  {
    p: 23,
    txt: "Gaslight was the first subscription utility: light, delivered monthly, by pipe",
  },
  { p: 112, txt: "the fluorescent office made light a management tool" },
  {
    p: 186,
    txt: "astronomers now petition cities for darkness the way parks once petitioned for light",
  },
];
...
export const PW_FEATURES = [
  {
    name: 'Unlimited "Explain this"',
    sub: "Any passage, at your level, with your context",
  },
  {
    name: "Summaries & translation",
    sub: "Whole pages, inline, in your language",
  },
  {
